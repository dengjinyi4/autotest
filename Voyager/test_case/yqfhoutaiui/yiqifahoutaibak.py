...
def mywebdriver():
    ...
    # chromedriver = allcase_list.webdriverpath()
...
def yqfcpsordershishihuizong(campaignId):
    ...
    for fr in listweek:
        try:
            ...
            time.sleep(2)
            # CPS订单明细页面  收订订单额
            cpsmingxi=driver.find_element_by_xpath('/html/body/center/div/table/tbody/tr[21]/td[14]').text
            time.sleep(2)
        except Exception,e:
...
if __name__ == '__main__':
    ...
    # week=getweeknew()
    # print allcase_list.webdriverpath()
