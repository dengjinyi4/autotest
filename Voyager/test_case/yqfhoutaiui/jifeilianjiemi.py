...
def jifeilianjiemi(driver,yiqifaurl):
    ...
    print '站点id：%s,站点id：%s,链接id：%s,广告主id:%s,交易id：%s，平台标识：%s'%(campainid,websiteid,linkid,Advertiserid,transactionid,pingtaibiaoshi)
    driver.close()
    driver.quit()
    return
if __name__ == '__main__':
    mydriver=mywebdriver()
    jifeilianjiemi(mydriver,'https://p.yiqifa.com/n?k=UZMWD748rI6H1NW7WmLErI6H2mLErntl1QLF6ltl6EBHWNKqrI6H3cLErnDlWE276nb9rIW-&e=123456&t=https://www.yhd.com/product/index.do')
    # print 1